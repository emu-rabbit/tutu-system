...
export const generateRegisterOptions = (arg: { email: string, username: string, }) => axios.post(`${BASEURL}/register/option`, { ...arg, rp_id: process.env.VUE_APP_RP_ID }, { withCredentials: true })
